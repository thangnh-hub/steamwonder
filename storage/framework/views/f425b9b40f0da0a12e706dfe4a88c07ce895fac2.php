                                    ...
                                    <ul class="nav nav-tabs">
                                        <li class="active">
                                            <a href="#tab_1" data-toggle="tab">
                                                <h5>Thông tin đơn vị <span class="text-danger">*</span></h5>
                                            </a>
                                        </li>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tab_1">
                                            <div class="d-flex-wap">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="sw_featured"><?php echo app('translator')->get('Đơn vị chính'); ?></label>
                                                        <div class="sw_featured d-flex-al-center">
                                                            <label class="switch ">
                                                                <input id="sw_featured" name="is_base" value="1" type="checkbox"
                                                                    <?php echo e(old('is_base') && old('is_base') == '1' ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\steamwonder\resources\views/admin/pages/meal/units/create.blade.php ENDPATH**/ ?>
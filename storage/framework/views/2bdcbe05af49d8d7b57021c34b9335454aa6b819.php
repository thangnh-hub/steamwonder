                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="json_params[exam_room]" class="form-control"
                                            value="<?php echo e(old('json_params[exam_room]')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="day_exam"
                                            placeholder="<?php echo app('translator')->get('Ngày thi'); ?>" value="<?php echo e(old('day_exam')); ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="time" class="form-control" name="start_time"
                                            placeholder="<?php echo app('translator')->get('Thời gian bắt đầu'); ?>" value="<?php echo e(old('time_exam')); ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="time" class="form-control" name="end_time"
                                            placeholder="<?php echo app('translator')->get('Thời gian kết thúc'); ?>" value="<?php echo e(old('time_exam')); ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dwn\resources\views/admin/pages/hv_exam_session/create.blade.php ENDPATH**/ ?>
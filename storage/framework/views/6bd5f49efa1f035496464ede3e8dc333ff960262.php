                ...
                <table class="table table-hover table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo app('translator')->get('Tiêu đề'); ?></th>
                            ...
                            <tr class="valign-middle">
                                ...
                                <td>
                                    <a class="btn btn-sm btn-warning" data-toggle="tooltip" title="<?php echo app('translator')->get('Update'); ?>"
                                       href="<?php echo e(route('relationships.edit', $row->id)); ?>">
                                        <i class="fa fa-pencil-square-o"></i>
                                    </a>
                
                                    <form action="<?php echo e(route('relationships.destroy', $row->id)); ?>" method="POST"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\steamwonder\resources\views/admin/pages/relationships/index.blade.php ENDPATH**/ ?>
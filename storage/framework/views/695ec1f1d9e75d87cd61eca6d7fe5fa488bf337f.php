...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content">
        ...
        <form action="<?php echo e(route(Request::segment(2) . '.update', $service->id)); ?>" method="POST"
                                                ...
                                                <select name="area_id" class="form-control select2" required>
                                                    ...
                                                    <?php $__currentLoopData = $list_area; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($item->id); ?>"
                                                            <?php echo e($item->id == old('area_id', $service->area_id) ? 'selected' : ''); ?>>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="service_category_id" class="form-control select2" required>
                                                    ...
                                                    <?php $__currentLoopData = $list_service_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($item->id); ?>"
                                                            <?php echo e($item->id == old('service_category_id', $service->service_category_id) ? 'selected' : ''); ?>>
                                                            <?php echo e($item->name); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="education_program_id" class="form-control select2"
                                                    ...
                                                    <?php $__currentLoopData = $list_education_program; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($item->id); ?>"
                                                            <?php echo e($item->id == old('education_program_id', $service->education_program_id) ? 'selected' : ''); ?>>
                                                            <?php echo e($item->name); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="education_age_id" class="form-control select2"
                                                    ...
                                                    <?php $__currentLoopData = $list_education_age; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($item->id); ?>"
                                                            <?php echo e($item->id == old('education_age_id', $service->education_age_id) ? 'selected' : ''); ?>>
                                                ...
                                                <select name="is_attendance" class="form-control select2"
                                                    ...
                                                    <?php $__currentLoopData = $list_is_attendance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($key); ?>"
                                                            <?php echo e($key == old('is_attendance', $service->is_attendance) ? 'selected' : ''); ?>>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="is_default" class="form-control select2" style="width: 100%;">
                                                    <?php $__currentLoopData = $list_is_default; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($key); ?>"
                                                            <?php echo e($key == old('is_default', $service->is_default) ? 'selected' : ''); ?>>
                                                            <?php echo e($item); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="service_type" class="form-control select2"
                                                    ...
                                                    <?php $__currentLoopData = $list_service_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($key); ?>"
                                                            <?php echo e($key == old('service_type', $service->service_type) ? 'selected' : ''); ?>>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="service_fee" class="form-control select2"
                                                    ...
                                                    <?php $__currentLoopData = $service_fees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($key); ?>"
                                                            <?php echo e($key == old('service_fee', $service->service_fee ?? '') ? 'selected' : ''); ?>>
                                                            <?php echo e(__($item)); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="status" class="form-control select2" style="width: 100%;">
                                                    <?php $__currentLoopData = $list_status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($key); ?>"
                                                            <?php echo e($key == old('status', $service->status) ? 'selected' : ''); ?>>
                                                            <?php echo app('translator')->get($item); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="iorder" class="form-control"
                                                    placeholder="<?php echo app('translator')->get('Nhập thứ tự'); ?>"
                                                    value="<?php echo e($service->iorder ?? ''); ?>">
                                            </div>
                                        </div>
                                            ...
                                            <?php $__currentLoopData = $details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="col-md-12" style="padding-left: 0px">
                                                    <div class="service-detail" data-key="<?php echo e($key); ?>">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label><?php echo app('translator')->get('Số tiền'); ?> <small
                                                                        class="text-danger">*</small></label>
                                                                <input required type="number"
                                                                    name="service_detail[<?php echo e($key); ?>][price]"
                                                                    class="form-control" placeholder="<?php echo app('translator')->get('Nhập số tiền'); ?>"
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label><?php echo app('translator')->get('Số lượng'); ?> <small
                                                                        class="text-danger">*</small></label>
                                                                <input required type="number"
                                                                    name="service_detail[<?php echo e($key); ?>][quantity]"
                                                                    class="form-control" placeholder="<?php echo app('translator')->get('Nhập số lượng'); ?>"
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label><?php echo app('translator')->get('Từ ngày'); ?> <small
                                                                        class="text-danger">*</small></label>
                                                                <input required type="date"
                                                                    name="service_detail[<?php echo e($key); ?>][start_at]"
                                                                    class="form-control"
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input required type="date"
                                                                    name="service_detail[<?php echo e($key); ?>][end_at]"
                                                                    class="form-control"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\steamwonder\resources\views/admin/pages/services/edit.blade.php ENDPATH**/ ?>
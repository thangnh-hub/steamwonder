                                                    ...
                                                    <div class="sw_featured d-flex-al-center">
                                                        <label class="switch ">
                                                            <input id="sw_featured" name="is_base" value="1" type="checkbox"
                                                                <?php echo e($detail->is_base && $detail->is_base == '1' ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\steamwonder\resources\views/admin/pages/meal/units/edit.blade.php ENDPATH**/ ?>
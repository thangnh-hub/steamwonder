                            ...
                            <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($row->parent_id == 0 || $row->parent_id == null): ?>
                                    <tr class="valign-middle">
                                        ...
                                        <?php
                                            $url_mapping = route('frontend.page', [
                                                'taxonomy' => $row->taxonomy_alias ?? '',
                                                'alias' => $row->alias ?? '',
                                            ]);
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\steamwonders\resources\views/admin/pages/cms_posts/index.blade.php ENDPATH**/ ?>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" class="form-control" required
                                                        value="<?php echo e(old('name')); ?>" placeholder="<?php echo app('translator')->get('Title'); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="iorder" class="form-control"
                                                        value="<?php echo e(old('iorder', 0)); ?>" placeholder="<?php echo app('translator')->get('Order'); ?>">
                                                </div>
                                            </div>
                                                    ...
                                                    <select name="status" class="form-control select2" style="width: 100%;">
                                                        <?php $__currentLoopData = $list_status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($key); ?>"
                                                                <?php echo e(old('status') == $key ? 'selected' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\steamwonder\resources\views/admin/pages/service_categorys/create.blade.php ENDPATH**/ ?>
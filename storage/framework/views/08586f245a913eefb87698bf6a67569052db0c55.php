                ...
                <?php if($row->parent_id == 0 || $row->parent_id == null): ?>
                  <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                    ...
                    <tr class="valign-middle">
                      <td><?php echo e(++$t); ?></td>
                      <td>
                        <strong style="font-size: 14px;"><?php echo e($row->username); ?></strong>
                      </td>
                      <td>
                        <strong style="font-size: 14px;"><?php echo e($row->first_name); ?></strong>
                      </td>
                      <td>
                        <strong style="font-size: 14px;"><?php echo e($row->last_name); ?></strong>
                      </td>

                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="time" class="form-control" name="start_time" placeholder="<?php echo app('translator')->get('Start'); ?>"
                            value="<?php echo e($detail->start_time ?? old('iorder')); ?>">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="time" class="form-control" name="end_time" placeholder="<?php echo app('translator')->get('End'); ?>"
                            value="<?php echo e($detail->end_time ?? old('iorder')); ?>">
                        </div>
                      </div>
                    </div>
                  </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\steamwonders\resources\views/admin/pages/periods/edit.blade.php ENDPATH**/ ?>
                    ...
                    <div class="d-flex-wap">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="date" class="form-control" name="start_date" placeholder="<?php echo app('translator')->get('Start date'); ?>"
                            value="">
                        </div>
                      </div>
                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\steamwonders\resources\views/admin/pages/rooms/create.blade.php ENDPATH**/ ?>
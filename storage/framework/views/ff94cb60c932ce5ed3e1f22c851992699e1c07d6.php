            ...
            <div class="col-md-2">
              <div class="form-group">
                ...
                <input class="form-control" name="date" type="date"
                  value="<?php echo e(isset($params['date']) ? date('Y-m-d', strtotime($params['date'])) : ''); ?>">
              </div>
            </div>
            <div class="col-md-2">
              <div class="form-group">
                <label><?php echo app('translator')->get('Month'); ?></label>
                <select class="form-control select2" name="month" id="">
                  <option value="">Chọn</option>
                  <?php for($i = 1; $i <= 12; $i++): ?>
                    <option <?php echo e(isset($params['month']) && $params['month'] == $i ? 'selected' : ''); ?>

                      value="<?php echo e($i); ?>">Tháng <?php echo e($i); ?></option>
                  <?php endfor; ?>
            ...
            <div class="col-md-2">
              <div class="form-group">
                ...
                <select class="form-control select2" name="year" id="">
                  <option value="">Chọn</option>
                  <?php for($i = date('Y', strtotime('+5 years')); $i >= date('Y', strtotime('+5 years')) - 10; $i--): ?>
                    <option <?php echo e(isset($params['year']) && $params['year'] == $i ? 'selected' : ''); ?>
              ...
              <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                  ...
                  <tr class="valign-middle">
                    ...
                    <td>
                      <?php echo e(date('l', strtotime($row->date))); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\steamwonders\resources\views/admin/pages/holidays/index.blade.php ENDPATH**/ ?>
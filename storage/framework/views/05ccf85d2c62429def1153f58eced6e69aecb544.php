                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="class_name"
                                    placeholder="<?php echo app('translator')->get('Tên chu kỳ'); ?>" value="<?php echo e(old('name')); ?>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="sw_featured d-flex-al-center">
                                    <label class="switch ">
                                        <input id="sw_featured" name="is_default" value="1" type="checkbox"
                                            <?php echo e(old('is_default') && old('is_default') == '1' ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\steamwonder\resources\views/admin/pages/payment_cycle/create.blade.php ENDPATH**/ ?>
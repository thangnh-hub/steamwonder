                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="from_unit_id" class="form-control select2" required>
                                                            ...
                                                            <?php $__currentLoopData = $list_units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($unit->id); ?>" <?php echo e(old('from_unit_id', $detail->unit_from_id ?? '') == $unit->id ? 'selected' : ''); ?>><?php echo e($unit->name ?? ""); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="to_unit_id" class="form-control select2" required>
                                                            <option value="">-- Chọn đơn vị --</option>
                                                            <?php $__currentLoopData = $list_units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($unit->id); ?>" <?php echo e(old('to_unit_id', $detail->unit_to_id ?? '') == $unit->id ? 'selected' : ''); ?>><?php echo e($unit->name ?? ""); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\steamwonder\resources\views/admin/pages/meal/unit_conversions/create.blade.php ENDPATH**/ ?>
                ...
                <div class="box-body d-flex-wap">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="from_month" placeholder="<?php echo app('translator')->get('From month'); ?>"
                                value="<?php echo e(old('from_month')); ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="to_month" placeholder="<?php echo app('translator')->get('To month'); ?>"
                                value="<?php echo e(old('to_month')); ?>" required>
                        </div>
                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\steamwonder\resources\views/admin/pages/education_ages/create.blade.php ENDPATH**/ ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="code"
                                                        placeholder="<?php echo app('translator')->get('Mã sản phẩm'); ?>" value="<?php echo e(old('code')); ?>"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="name"
                                                        placeholder="<?php echo app('translator')->get('Tên sản phẩm'); ?>" value="<?php echo e(old('name')); ?>"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label><?php echo app('translator')->get('Loại sản phẩm'); ?><small class="text-red">*</small></label>
                                                            ...
                                                            <?php if($val->category_parent==""||$val->category_parent==NULL): ?>
                                                                ...
                                                                <?php $__currentLoopData = $list_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row_child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <?php if($row_child->category_parent==$val->id): ?>
                                                                        <option value="<?php echo e($row_child->id); ?>">--- <?php echo e($row_child->code??""); ?></option>
                                                                    <?php endif; ?>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            <?php endif; ?>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="unit"
                                                        placeholder="<?php echo app('translator')->get('Đơn vị tính'); ?>" value="<?php echo e(old('unit')); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="price"
                                                        placeholder="<?php echo app('translator')->get('price'); ?>" value="<?php echo e(old('price')); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="<?php echo e(old('json_params[specification]')); ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="json_params[origin]"
                                                        ...
                                                        value="<?php echo e(old('json_params[origin]')); ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="<?php echo e(old('json_params[manufacturer]')); ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="<?php echo e(old('json_params[warranty]')); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="code_auto"
                                                        ...
                                                        value="<?php echo e(old('code_auto')); ?>">
                                                </div>
                                            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\steamwonders\resources\views/admin/pages/warehouse_product/create.blade.php ENDPATH**/ ?>
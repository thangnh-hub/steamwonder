            ...
            <form action="<?php echo e(route(Request::segment(2) . '.index')); ?>" method="GET">
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label><?php echo app('translator')->get('Kỹ năng thi'); ?></small></label>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label><?php echo app('translator')->get('Giám thị'); ?></label>
                                <select name="id_invigilator" class="form-control select2 w-100">
                                    ...
                                    <?php $__currentLoopData = $list_admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($val->id); ?>"
                                            <?php echo e(isset($params['id_invigilator']) && $params['id_invigilator'] == $val->id ?'selected':''); ?>>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label><?php echo app('translator')->get('Người chấm'); ?></label>
                                <select name="id_grader_exam" class="form-control select2 w-100">
                                    <option value=""><?php echo app('translator')->get('Please choose'); ?></option>
                                    <?php $__currentLoopData = $list_admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($val->id); ?>"
                                            <?php echo e(isset($params['id_grader_exam']) && $params['id_grader_exam'] == $val->id ?'selected':''); ?>>
                                            <?php echo app('translator')->get($val->name ?? ''); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                    ...
                    <table class="table table-hover table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo app('translator')->get('Từ'); ?></th>
                                <th><?php echo app('translator')->get('Đến'); ?></th>
                                <th><?php echo app('translator')->get('Giám thị'); ?></th>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="valign-middle">
                                    ...
                                    <td>
                                        <?php echo e(date('d-m-Y',strtotime($row->day_exam))); ?>
                                    ...
                                    <td>
                                        <?php echo e($row->invigilator->name ?? ''); ?>

                                    </td>
                                    <td>
                                        <?php echo e($row->grader_exam->name ?? ''); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dwn\resources\views/admin/pages/hv_exam_session/index.blade.php ENDPATH**/ ?>
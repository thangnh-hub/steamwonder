                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="code" id="code"
                                    placeholder="<?php echo app('translator')->get('Mã chính sách'); ?>" value="<?php echo e(old('code')); ?>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="class_name"
                                    placeholder="<?php echo app('translator')->get('Tên chính sách'); ?>" value="<?php echo e(old('name')); ?>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php $__currentLoopData = $service; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item_service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="d-flex-wap item_service">
                                        ...
                                        <input placeholder="Nhập số tiền (hoặc %) giảm trừ"
                                            class="item_number_hssv form-control mr-10 check_disable " disabled
                                            style="width:250px;"
                                        ...
                                        <select name="json_params[services][<?php echo e($item_service->id); ?>][type]"
                                            class="form-control select2 mr-10 check_disable" disabled style="width: 250px">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\steamwonder\resources\views/admin/pages/policies/create.blade.php ENDPATH**/ ?>
                            ...
                            <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                                    ...
                                    <tr class="valign-middle">
                                        ...
                                        <td><?php echo e($row->admin_approved->name ?? ''); ?></td>
                                        <td class="hide-print">
                                            <?php if($row->status == 'not approved'): ?>
                                            ...
                                            <?php elseif($row->status == 'approved'): ?>
                                                <a href="<?php echo e(route('entry_warehouse.create', ['order_id' => $row->id])); ?>"
                                                    target="_blank" rel="noopener noreferrer"
                                                    class="btn btn-sm btn-primary">
                                                    Nhập kho
                                                    <i class="fa fa-sign-in"></i>
                                                </a>
                                            <?php elseif($row->status == 'in warehouse'): ?>
                                                <a href="<?php echo e(route('entry_warehouse.show', $row->entry->id)); ?>"
                                                    target="_blank" rel="noopener noreferrer"
...
<?php $__env->startSection('script'); ?>
    <script>
        $('.approve_order').click(function(e) {
            if (confirm('Bạn có chắc chắn muốn duyệt đề xuất mua sắm này ?')) {
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\steamwonders\resources\views/admin/pages/warehouse_order_buy/index.blade.php ENDPATH**/ ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><?php echo app('translator')->get('Mã chính sách'); ?> <small class="text-red">*</small></label>
                                <input type="text" class="form-control" name="code" id="code"
                                    placeholder="<?php echo app('translator')->get('Mã chính sách'); ?>" value="<?php echo e($detail->code ?? old('code')); ?>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><?php echo app('translator')->get('Tên chính sách'); ?> <small class="text-red">*</small></label>
                                <input type="text" class="form-control" name="name" id="class_name"
                                    placeholder="<?php echo app('translator')->get('Tên chính sách'); ?>" value="<?php echo e($detail->name ?? old('name')); ?>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                    ...
                                    <li class="d-flex-wap item_service">
                                        ...
                                        <select name="json_params[services][<?php echo e($item_service->id); ?>][type]"
                                            ...
                                            <?php $__currentLoopData = $type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($item); ?>" <?php echo e(isset($detail->json_params->services->{$item_service->id}->type) && $detail->json_params->services->{$item_service->id}->type == $item ?'selected':''); ?>><?php echo e(__($item)); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\steamwonders\resources\views/admin/pages/policies/edit.blade.php ENDPATH**/ ?>
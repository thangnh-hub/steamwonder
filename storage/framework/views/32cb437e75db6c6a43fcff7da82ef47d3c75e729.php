                    ...
                    <div class="panel-body">
                        <div class="text-center">
                            ...
                            <div class="panel-body">
                                ...
                                <form id="register-form" action="<?php echo e(route('frontend.password.reset.post')); ?>" role="form" autocomplete="off" class="form"
                                    method="post">
                                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\steamwonder\resources\views/frontend/pages/user/reset_password.blade.php ENDPATH**/ ?>
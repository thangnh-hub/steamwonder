                                ...
                                <select name="status" id="status" class="form-control select2" style="width: 100%;">
                                    ...
                                    <?php $__currentLoopData = $status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item); ?>"
                                            <?php echo e(isset($params['status']) && $params['status'] == $item ? 'selected' : ''); ?>>
            ...
            <div class="box-body table-responsive">
                ...
                <?php else: ?>
                    <table class="table table-hover table-bordered">
                        <thead>
                            <tr>
                                <th><?php echo app('translator')->get('Tuổi'); ?></th>
                                <th><?php echo app('translator')->get('Từ tháng'); ?></th>
                                <th><?php echo app('translator')->get('Đến tháng'); ?></th>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="valign-middle">
                                    ...
                                    <td>
                                        <?php echo e($row->from_month ?? 0); ?> tháng
                                    </td>
                                    <td>
                                        <?php echo e($row->to_month ?? 0); ?> tháng
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <?php echo e(\Carbon\Carbon::parse($row->created_at)->format('d/m/Y')); ?></p>
                                    </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\steamwonder\resources\views/admin/pages/education_ages/index.blade.php ENDPATH**/ ?>
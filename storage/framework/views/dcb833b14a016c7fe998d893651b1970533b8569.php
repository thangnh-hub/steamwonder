                ...
                <div class="col-lg-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo app('translator')->get('Sửa cấu hình đề thi'); ?></h3>
                                        ...
                                        <div class="col-xs-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input required type="number" name="json_params[time]" class="form-control"
                                                    value="<?php echo e($detail->json_params->time ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12 mt-10">
                                            <div class="form-group">
                                                ...
                                                <div class="box_group mt-10">
                                                    <?php if(!empty($detail->json_params->topic) && count((array) $detail->json_params->topic) > 0): ?>
                                                        <?php $__currentLoopData = $detail->json_params->topic; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select required class="form-control select2 w-100"
                                                                            ...
                                                                            <option value=""><?php echo app('translator')->get('Please choose'); ?>
                                                                            </option>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label><?php echo app('translator')->get('Mô tả'); ?> <small
                                                                                class="text-red">*</small></label>
                                                                        <textarea required type="text" name="topic[<?php echo e($k); ?>][content]" class="form-control input_content"><?php echo e($item->content ?? ''); ?></textarea>
                                                                    </div>
                                                                </div>
                                                                        ...
                                                                        <div class="sw_featured d-flex-al-center">
                                                                            <label class="switch ">
                                                                                <input class="input_mix"
                                                                                    name="topic[<?php echo e($k); ?>][mix]"
                                                                                    value="1" type="checkbox"
                                                                                    <?php echo e(isset($item->mix) && $item->mix == '1' ? 'checked' : ''); ?>>
        ...
        $('.add_group').click(function() {
            ...
            let _html = `
                <div class="d-flex-wap item_group mt-10 align-center">
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            <label><?php echo app('translator')->get('Số câu hỏi tương ứng'); ?> <small class="text-red">*</small></label>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dwn\resources\views/admin/pages/hv_exam_option/edit.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content">
        ...
        <form role="form" onsubmit="return confirm('<?php echo app('translator')->get('confirm_action'); ?>')" action="<?php echo e(route('entry_warehouse.store')); ?>"
            method="POST">
            <?php echo csrf_field(); ?>
                ...
                <div class="col-lg-12">
                    <div class="box box-primary">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="month" class="form-control" name="period"
                                            value="<?php echo e($detail->period ?? date('Y-m', time())); ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                            ...
                                            <?php if(isset($list_order)): ?>
                                                <?php $__currentLoopData = $list_order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item->id); ?>">
                                                        <?php echo e($item->name . ' (' . $item->code . ')'); ?>
                        ...
                        <div class="box-footer">
                            <a class="btn btn-sm btn-success" href="<?php echo e(route('entry_warehouse')); ?>">
...
<?php $__env->startSection('script'); ?>
    <?php if(isset($order_selected)): ?>
        <script>
            ...
            $(document).ready(function() {
                ...
                const order_id = <?php echo e($order_selected->id); ?>; // Giá trị muốn chọn
                $select.val(order_id);
                // Gửi sự kiện change
    ...
    <script>
        ...
        $('.order_id').change(function() {
            ...
            let url = "<?php echo e(route('warehouse_order_detail_by_order')); ?>";
        ...
        $('.warehouse_avaible').change(function() {
            ...
            let url = "<?php echo e(route('order_by_warehouse')); ?>";
            ...
            if (_warehouse_id > 0) {
                $.ajax({
                    ...
                    data: {
                        ...
                        warehouse_id: _warehouse_id,
                        type: 'buy',
                        status: "<?php echo e(App\Consts::APPROVE_WAREHOUSE_ORDER['approved']); ?>",
                    },
                    success: function(response) {
                        if (response.message == 'success') {
                            let list = response.data || null;
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\steamwonder\resources\views/admin/pages/warehouse_entry/create.blade.php ENDPATH**/ ?>
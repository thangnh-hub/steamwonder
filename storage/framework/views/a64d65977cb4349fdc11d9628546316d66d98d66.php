                    ...
                    <div class="d-flex-wap">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-6">
                        <div class="form-group">
                          ...
                          <input type="password" class="form-control" name="password" placeholder="<?php echo app('translator')->get('Password must be at least 8 characters'); ?>"
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="<?php echo app('translator')->get('Mã Code'); ?>" name="admin_code"
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="date" class="form-control" name="birthday" placeholder="<?php echo app('translator')->get('Birthday'); ?>"
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="json_params[position]"
                            placeholder="<?php echo app('translator')->get('Position'); ?>" value="<?php echo e(old('json_params[position]') ?? ''); ?>">
                        </div>
                      </div>
                      ...
                      <?php $__currentLoopData = $area; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-4">
                          <ul class="checkbox_list">
                            ...
                            ?>
                            <li>
                              <input name="json_params[area_id][]" type="checkbox" value="<?php echo e($items->id); ?>"
                                id="json_access_menu_id_<?php echo e($items->id); ?>" class="mr-15" <?php echo e($checked); ?>>
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <select name="json_params[role_extend][]" id="role_extend" class="form-control select2"
                  ...
                  <option value=""><?php echo app('translator')->get('Please select'); ?></option>
                  <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($item->id); ?>" <?php echo e(in_array($item->id, $arr_role_extend) ? 'selected' : ''); ?>>
                      <?php echo e($item->name); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\steamwonders\resources\views/admin/pages/admins/create.blade.php ENDPATH**/ ?>
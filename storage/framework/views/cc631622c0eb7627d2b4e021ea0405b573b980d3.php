                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" class="form-control" required
                                                        value="<?php echo e(old('name', $detail->name)); ?>" placeholder="<?php echo app('translator')->get('name'); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="iorder" class="form-control"
                                                        value="<?php echo e(old('iorder', $detail->iorder ?? 0)); ?>" placeholder="<?php echo app('translator')->get('Order'); ?>">
                                                </div>
                                            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\steamwonder\resources\views/admin/pages/service_categorys/edit.blade.php ENDPATH**/ ?>
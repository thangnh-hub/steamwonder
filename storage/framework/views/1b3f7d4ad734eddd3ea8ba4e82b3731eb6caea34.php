                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="keyword" placeholder="<?php echo app('translator')->get('Tên phòng ban, mã phòng ban..'); ?>"
                    ...
                    <table class="table table-hover table-bordered table-responsive">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo app('translator')->get('Mã phòng ban'); ?></th>
                                <th><?php echo app('translator')->get('Tên phòng ban'); ?></th>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\steamwonder\resources\views/admin/pages/warehouse_department/index.blade.php ENDPATH**/ ?>
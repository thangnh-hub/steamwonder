            ...
            <form action="<?php echo e(route(Request::segment(2) . '.index')); ?>" method="GET">
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label><?php echo app('translator')->get('Xếp loại'); ?></label>
                                <select name="ranks" class="form-control select2"
                                    style="width: 100%;">
                                    <option value=""><?php echo app('translator')->get('Please select'); ?></option>
                                    <?php $__currentLoopData = $ranks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($key); ?>"
                                        <?php echo e(isset($params['ranks']) && $params['ranks'] == $key ? 'selected' : ''); ?>>
                    ...
                    <table class="table table-hover table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo app('translator')->get('Từ điểm'); ?></th>
                                <th><?php echo app('translator')->get('Đến điểm'); ?></th>
                            ...
                            <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                                    ...
                                    <tr class="valign-middle">
                                        ...
                                        <td>
                                            <?php echo e($row->from_points??""); ?>

                                        </td>
                                        <td>
                                            <?php echo e($row->to_points??""); ?>

                                        </td>
                                        <td>
                                            <?php echo e(App\Consts::ranked_academic[$row->ranks]??""); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\dwn\resources\views/admin/pages/ranked_academics/index.blade.php ENDPATH**/ ?>
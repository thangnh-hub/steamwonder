...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content">
        ...
        <form role="form" action="<?php echo e(route('warehouse_reimburse.store')); ?>" method="POST"
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo app('translator')->get('Thông tin hoàn trả tài sản'); ?></h3>
                        </div>
                        <div class="box-body">
                            <div class="d-flex-wap">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo app('translator')->get('Tên phiếu hoàn trả'); ?> <small class="text-red">*</small></label>
                                        <input type="text" class="form-control" name="name"
                                            placeholder="<?php echo app('translator')->get('Tên phiếu hoàn trả'); ?>" value="<?php echo e(old('name')); ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                ...
                <div class="col-lg-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo app('translator')->get('Chọn tài sản hoàn trả'); ?></h3>
                        </div>
                        <div class="box-body">
                            <div class="d-flex-wap">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label><?php echo app('translator')->get('Cơ sở hoàn trả'); ?><small class="text-red">*</small></label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label><?php echo app('translator')->get('Kho hoàn trả'); ?><small class="text-red">*</small></label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <h4><?php echo app('translator')->get('Danh sách tài sản hoàn trả'); ?></h4>
                                    </div>
                        ...
                        <div class="box-footer">
                            <a class="btn btn-sm btn-success" href="<?php echo e(route('warehouse_reimburse.index')); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\steamwonders\resources\views/admin/pages/warehouse_recall/reimburse_create.blade.php ENDPATH**/ ?>
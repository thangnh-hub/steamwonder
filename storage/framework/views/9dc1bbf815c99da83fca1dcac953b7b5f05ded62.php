        ...
        <div class="box">
            <div class="box-header">
                ...
                <div class="box_note">
                    ...
                    <ul>
                        <li> Màn hình chỉ hiển thị danh sách các đơn của bạn và các đơn của các bộ cấp dưới bạn quản lý</li>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dwn\resources\views/admin/pages/leaves/request_index.blade.php ENDPATH**/ ?>
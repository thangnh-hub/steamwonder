                                ...
                                <select required name="months" class="form-control select2 w-100">
                                    ...
                                    <?php for($i = 1; $i <= 12; $i++): ?>
                                        <option value="<?php echo e($i); ?>"
                                            <?php echo e($detail->months && $detail->months == $i ? 'selected' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\steamwonder\resources\views/admin/pages/payment_cycle/edit.blade.php ENDPATH**/ ?>
...
class ProductCategoryController extends Controller
{
   ...
   *
   * @param  \App\Models\CmsTaxonomy  $productCategory
   * @return \Illuminate\Http\Response
   */
  public function show(CmsTaxonomy  $productCategory)
  {
   ...
   * @return \Illuminate\Http\Response
   */
  public function edit(CmsTaxonomy  $productCategory)
  {
   ...
   * @return \Illuminate\Http\Response
   */
  public function update(Request $request, CmsTaxonomy  $productCategory)
  {
    $request->validate([
      'name' => 'required|max:255',
    ]);
   ...
   * @return \Illuminate\Http\Response
   */
  public function destroy(CmsTaxonomy $productCategory)
  {
    $productCategory->status = Consts::STATUS_DELETE;
    $productCategory->save();

    // Update delete status sub
    CmsTaxonomy::where('parent_id', '=', $productCategory->id)->update(['status' => Consts::STATUS_DELETE]);

...
class FieldController extends Controller
{
    ...
    {
        $this->routeDefault  = 'fields';
        $this->viewPart = 'admin.pages.fields';
        $this->responseData['module_name'] = __('Quản lý nhóm ngành du học');
    }
    /**
    ...
    public function index(Request $request)
    {
        ...
        $rows = Field::getSqlField($params)->paginate(Consts::DEFAULT_PAGINATE_LIMIT);
    ...
    {
        $this->responseData['detail'] = $field;
        $this->responseData['status'] = Consts::STATUS;
        $this->responseData['route_name'] = Consts::ROUTE_NAME;
    ...
    public function update(Request $request, Field $field)
    {
        ...
        if ($field->json_params != "") {
            foreach ($field->json_params as $key => $val) {
    ...
    {
        $field->status = Consts::STATUS_DELETE;
        $field->save();

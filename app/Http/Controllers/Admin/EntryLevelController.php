...
class EntryLevelController extends Controller
{
    ...
    {
        $this->routeDefault  = 'entry_levels';
        $this->viewPart = 'admin.pages.entry_levels';
        $this->responseData['module_name'] = 'Entry levels Management';
    }
    /**
    ...
    public function index(Request $request)
    {
        ...
        $rows = EntryLevel::getsqlEntryLevel($params)->paginate(Consts::DEFAULT_PAGINATE_LIMIT);
    ...
    public function store(Request $request)
    {
        ...
        $entryLevel = EntryLevel::create($params);
        return redirect()->route($this->routeDefault . '.index')->with('successMessage', __('Add new successfully!'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(EntryLevel $entryLevel)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(EntryLevel $entryLevel)
    {
        $this->responseData['detail'] = $entryLevel;
        $this->responseData['status'] = Consts::STATUS;
        $this->responseData['route_name'] = Consts::ROUTE_NAME;
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, EntryLevel $entryLevel)
    {
        $request->validate([
        ...
        if ($entryLevel->json_params != "") {
            foreach ($entryLevel->json_params as $key => $val) {
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(EntryLevel $entryLevel)
    {
        $entryLevel->status = Consts::STATUS_DELETE;
        $entryLevel->save();

                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" name="day_opening"
                                                        placeholder="@lang('Ngày khai giảng')" value="{{ old('day_opening') ?? ($detail->day_opening ?? '') }}"
                                                        >
                                                </div>
                                            </div>
                                            {{-- <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="json_params[bai_hoc]"
                                                        ...
                                                        value="{{ old('json_params[bai_hoc]') ?? ($detail->json_params->bai_hoc ?? '')}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="json_params[slot]"
                                                        ...
                                                        value="{{ old('json_params[slot]') ?? ($detail->json_params->slot ?? '') }}">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="json_params[brief][{{ $lang }}]" class="form-control" rows="5" id="brief_vi">{{ old('json_params[brief][' . $lang . ']') ?? ($detail->json_params->brief->$lang ?? '') }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="json_params[target][{{ $lang }}]" class="form-control" rows="5" id="target_vi">{{ old('json_params[target][' . $lang . ']') ?? ($detail->json_params->target->$lang ?? '') }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="json_params[des][{{ $lang }}]" class="form-control" rows="5" id="des_vi">{{ old('json_params[des][' . $lang . ']') ?? ($detail->json_params->des->$lang ?? '') }}</textarea>
                                                    </div>
                                                </div>
                                            </div> --}}
                                        </div>
                            ...
                            <div class="form-group">
                                <select name="syllabus_id" class=" syllabus_avaible form-control select2">
                                    ...
                                    @foreach ($syllabus as $val)
                                        @if (isset($detail->level_id) && $detail->level_id == $val->level_id)
                                            <option value="{{ $val->id }}"

                                        ...
                                        <div class="d-flex-wap">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="json_params[student][id]" id="student_id"
                                                        class="form-control select2" required>
                                                        <option value="">@lang('Please choose')</option>
                                                        @foreach ($students as $key => $student)
                                                            <option value="{{ $student->id }}"
                                                                {{ isset($detail->json_params->student->id) && $student->id == $detail->json_params->student->id ? 'selected' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="code" name="code"
                                                        placeholder="@lang('Nội dung biến động')" value="{{ $detail->code }}"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" name="active_date" required
                                                        placeholder="@lang('Ngày biến động')"
                                                        value="{{ date('Y-m-d', strtotime($detail->active_date)) }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>@lang('Đã làm đơn?')</label>
                                                    <br>
                                                    <input type="checkbox" value="1"  name="is_sign" {{ isset($detail->is_sign) && $detail->is_sign == 1 ?"checked":"" }}>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                          ...
                          @isset($students)
                            @foreach ($students as $item)
                              <tr>
                                ...
                                <td>
                                  <input name="json_params[student][]" type="checkbox"
                                    value="{{ $item->id }}" class="mr-15 student_item cursor"

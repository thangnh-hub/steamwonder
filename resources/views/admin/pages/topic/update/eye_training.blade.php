            ...
            <div class="tab-pane active">
                <div class="col-md-12 textarea-question">
                    <div class="form-group">
                        ...
                        <textarea id="question_textarea_update" required class="form-control input-question" name="question" cols="30"
                            rows="3" placeholder="Nhập câu hỏi...">{{ $question->question }}</textarea>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">

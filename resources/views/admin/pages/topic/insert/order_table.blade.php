            ...
            <div class="tab-pane active">
                <div class="col-md-12 textarea-question">
                    <div class="form-group">
                        ...
                        <textarea id="question_textarea_insert" required class="form-control input-question" name="question" cols="30"
                            rows="1" placeholder="Nhập câu hỏi..."></textarea>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                    ...
                    <div class="list_answer ">
                        ...
                        <div class="d-flex-wap more_answer">
                            <div class="col-md-3 pl-0">
                                <div class="form-group">
                                    <input type="text" name="json_params[answer][]" class="form-control"

                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="json_params[dad_name]"
                                                        placeholder="@lang('Father full name')" value="{{ old('json_params[dad_name]') ?? $detail->json_params->dad_name ?? '' }}"
                                                        >
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="json_params[dad_phone]"
                                                        placeholder="@lang('Father phone')" value="{{ old('json_params[dad_phone]') ?? $detail->json_params->dad_phone ?? '' }}"
                                                        >
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="json_params[mami_name]"
                                                        placeholder="@lang('Mother full name')" value="{{ old('json_params[mami_name]') ?? $detail->json_params->mami_name ?? '' }}"
                                                        >
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="json_params[mami_phone]"
                                                        placeholder="@lang('Mother phone')" value="{{ old('json_params[mami_phone]') ?? $detail->json_params->mami_phone ?? '' }}"
                                                        >
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="json_params[cccd]"
                                                        placeholder="@lang('CCCD / CMT')" value="{{ old('json_params[cccd]') ?? $detail->json_params->cccd ?? '' }}"
                                                        >
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" name="json_params[date_range]"
                                                        placeholder="@lang('Date range')" value="{{ old('json_params[date_range]') ?? $detail->json_params->date_range ?? '' }}"
                                                        >
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="json_params[issued_by]"
                                                        placeholder="@lang('Issued by')" value="{{ old('json_params[issued_by]') ?? $detail->json_params->issued_by ?? '' }}"
                                                        >
                                                </div>
                                            </div>
                                        </div>

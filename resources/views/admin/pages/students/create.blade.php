    ...
    <section class="content">
        ...
        <form role="form" action="{{ route(Request::segment(2) . '.store') }}" method="POST" id="form_product">
            ...
            <input type="hidden" name="admission_id"
                value="{{ isset($admin_auth->id) && $admin_auth->id ? $admin_auth->id : '' }}">
            @if ($lang != '')
            ...
            <div class="row">
                                            ...
                                            {{-- <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="email"
                                                        placeholder="@lang('Email')" value="" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="admin_code"
                                                        placeholder="@lang('Admin code')" value="" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="name"
                                                        placeholder="@lang('Full name')" value="{{ old('name') }}"
                                                        required>
                                                </div>
                                            </div>
                                            {{-- <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        name="json_params[middle_name]" placeholder="@lang('Middle name')"
                                                        value="{{ old('json_params[middle_name]') }}" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        name="json_params[first_name]" placeholder="@lang('First name')"
                                                        value="{{ old('json_params[first_name]') }}" required>
                                                </div>
                                            </div> --}}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="admission_id" class=" form-control select2">
                                                        ...
                                                        @foreach ($admission as $val)
                                                            <option value="{{ $val->id }}"
                                                                {{ isset($admin_auth->id) && $admin_auth->id == $val->id ? 'selected' : '' }}>
                                                                {{ $val->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ old('json_params[dad_name]') }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ old('json_params[dad_phone]') }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ old('json_params[mami_name]') }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ old('json_params[mami_phone]') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="json_params[cccd]"
                                                        placeholder="@lang('CCCD / CMT')"
                                                        value="{{ old('json_params[cccd]') }}" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control"
                                                        ...
                                                        value="{{ old('json_params[date_range]') }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ old('json_params[issued_by]') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">@lang('Gender') <small class="text-red">*</small></h3>
                        </div>
                        <div class="box-body">
                            <div class="form-group">
                                <select name="gender" class=" form-control select2" required>
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">@lang('Thuộc khu vực') <span class="text-danger">*</span></h3>
                        </div>
                        <div class="box-body">
                            <div class="form-group">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">@lang('Khóa học') <small class="text-red">*</small></h3>
                        </div>
                        <div class="box-body">
                            <div class="form-group">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="btn-set">
                                ...
                                &nbsp;&nbsp;
                                <a class="btn btn-success " href="{{ $admin_auth->role == 11 ? route('student.cskh') : route(Request::segment(2) . '.index') }}">

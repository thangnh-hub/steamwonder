                                        ...
                                        <div class="d-flex-wap">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="name">@lang('Tên danh mục thực phẩm') <span class="text-danger">*</span></label>
                                                    <input placeholder="@lang('Tên danh mục thực phẩm')" type="text" name="name" class="form-control" value="{{ old('name', $detail->name ?? '') }}" required>
                                                </div>
                                            </div>

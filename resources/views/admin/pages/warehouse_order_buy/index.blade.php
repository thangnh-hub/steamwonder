                                    ...
                                    <tr class="valign-middle">
                                        ...
                                        <td class="hide-print">
                                            ...
                                            @elseif($row->status == 'approved')
                                                <a href="{{ route('entry_warehouse.create', ['order_id' => $row->id]) }}"
                                                    target="_blank" rel="noopener noreferrer"
                                                    class="btn btn-sm btn-primary">
                                                    Nhập kho
                                                    <i class="fa fa-sign-in"></i>
                                                </a>
                                            @elseif($row->status == 'in warehouse')
                                                <a href="{{ route('entry_warehouse.show', $row->entry->id) }}"
                                                    target="_blank" rel="noopener noreferrer"

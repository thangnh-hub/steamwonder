                            ...
                            <div class="form-group">
                                ...
                                <select name="status" required class="form-control select2 w-100">
                                    @foreach ($status as $key => $val)
                                        <option value="{{ $key }}"
                                            {{ old('status') && old('status') == $key ? 'selected' : '' }}>
                                            {{ __($val) }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select required name="type" class="form-control select2 w-100">
                                    ...
                                    @foreach ($type as $key => $val)
                                        <option value="{{ $key }}"
                                            {{ old('type') && old('type') == $key ? 'selected' : '' }}>
                                            {{ __($val) }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select required name="condition_type" class="form-control select2 w-100">
                                    ...
                                    @foreach ($condition_type as $key => $val)
                                        <option value="{{ $key }}"
                                            {{ old('condition_type') && old('condition_type') == $key ? 'selected' : '' }}>
                                            {{ __($val) }}</option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <div class="sw_featured d-flex-al-center">
                                    <label class="switch ">
                                        <input id="sw_featured" name="is_cumulative" value="1" type="checkbox"
                                            {{ old('is_cumulative') && old('is_cumulative') == '1' ? 'checked' : '' }}>

                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="date" name="day_exam" class="form-control" value="{{ isset($params['day_exam']) ? $params['day_exam'] : '' }}">
                            </div>
                        </div>
                        ...
                        <tbody>
                            @foreach ($rows as $row)
                                <form action="{{ route(Request::segment(2) . '.destroy', $row->id) }}" method="POST"
                                    onsubmit="return confirm('@lang('Duyên Đỗ lưu ý:Bạn có chắc muốn xóa bản ghi này?')')">
                                    <tr class="valign-middle">
                                        ...
                                        <td>
                                            <a href="{{ route('exam_session_user.index',['exam_id' => $row->id]) }}">Link kết quả</a>
                                        </td>
                                        <td>
                                            {{ $row->updated_at }}
                                        </td>

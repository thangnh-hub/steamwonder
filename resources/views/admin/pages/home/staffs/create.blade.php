            ...
            <div class="row">
                                ...
                                <ul class="nav nav-tabs">
                                    <li class="active">
                                        <a href="#tab_2_1" data-toggle="tab">
                                            <h5>Thông tin giáo viên<span class="text-danger">*</span></h5>
                                        </a>
                                    </li>
                                </ul>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab_2_1">
                                        <div class="d-flex-wap">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="gender" class=" form-control select2">
                                                        @foreach ($gender as $key => $val)
                                                            <option value="{{ $key }}"
                                                                {{ isset($detail->gender) && $detail->gender == $val ? 'checked' : '' }}>
                                                                @lang($val)</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>@lang('Position') <small class="text-red">*</small></label>
                                                    <input type="text" class="form-control" name="json_params[position]"
                                                        placeholder="@lang('Position')" value="{{ old('json_params[position]') }}"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <select name="json_params[direct_manager_id]" class=" form-control select2">
                                    <option value="">@lang('Please select')</option>
                                    @foreach ($direct_manager as $val)
                                        <option value="{{ $val->id }}"
                                            {{ isset($detail->json_params->direct_manager_id) && $detail->json_params->direct_manager_id == $val->id ? 'selected' : '' }}>
                                            {{ $val->name }}</option>
                                    @endforeach
                                </select>
                            </div>

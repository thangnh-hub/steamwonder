...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box box-default hide-print">
            ...
            <form action="{{ route('report.timekeeping.teacher') }}" method="GET">
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <a class="btn btn-default btn-sm" href="{{ route('report.timekeeping.teacher') }}">
                                        @lang('Reset')
                                    </a>
                                    ...
                                    <a target="_blank" style="margin-left: 10px" class="btn btn-warning btn-sm"
                                        href="{{ route('report.timekeeping.calender', ['month' => $params['month'] ?? '', 'keyword' => $params['keyword'] ?? '']) }}">
                                        @lang('Xem chi tiết')
                                    </a>
                                </div>
                            </div>
                    ...
                    <table class="table table-bordered sticky">
                        <thead>
                            <tr>
                                ...
                                <th rowspan="2">@lang('Trình độ lớp')</th>
                                ...
                                @foreach ($item->classs as $item_class)
                                    @if ($i == 1)
                                        <tr>
                                            ...
                                            <td>{{ $item_class->class->students->count() }}</td>
                                            <td>{{ $item_class->class->level->name ?? '' }}</td>
                                            <td>{{ App\Consts::CLASS_STATUS[$item_class->class->status] ?? '' }}</td>
                                            ...
                                            <td>
                                                {{ $item_class->thongke_buoihoc->attendant_in_month }}
                                                (Full:{{ $item_class->thongke_buoihoc->total_fulltime }},
                                                Part:{{ $item_class->thongke_buoihoc->total_parttime }})
                                            </td>

        ...
        <form role="form" action="{{ route(Request::segment(2) . '.store') }}" method="POST"
            ...
            <div class="row">
                            ...
                            <div class="d-flex-wap">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>@lang('Tên phiếu thu hồi') <small class="text-red">*</small></label>
                                        <input type="text" class="form-control" name="name"
                                            placeholder="@lang('Tên phiếu thu hồi')" value="{{ old('name') }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                ...
                <div class="col-lg-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">@lang('Chọn tài sản thu hồi')</h3>
                        </div>
                        <div class="box-body">
                            <div class="d-flex-wap">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>@lang('Cơ sở thu hồi')<small class="text-red">*</small></label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>@lang('Kho thu hồi')<small class="text-red">*</small></label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <h4>@lang('Danh sách tài sản thu hồi')</h4>
                                    </div>
        ...
        function filter_asset() {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    status: "{{ App\Consts::WAREHOUSE_ASSET_STATUS['deliver'] }}",
                },

...
@section('content-header')
    ...
    <section class="content-header">
        <h1>
            @lang($module_name)
            <a class="btn btn-sm btn-warning pull-right" href="{{ route('warehouse_reimburse.create') }}"><i
...
@section('content')
    <section class="content">
        ...
        <div class="box box-default hide-print">
            ...
            <form action="{{ route('warehouse_reimburse.index') }}" method="GET">
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <a class="btn btn-default btn-sm" href="{{ route('warehouse_reimburse.index') }}">
                                        @lang('Reset')
                                    </a>
                                </div>
                            </div>
                    ...
                    <table class="table table-hover table-bordered table-responsive">
                        <thead>
                            <tr>
                                ...
                                <th>@lang('Kho')</th>
                                <th>@lang('Mã phiếu')</th>
                                <th>@lang('Tên phiếu hoàn trả')</th>
                                <th>@lang('Số sản phẩm')</th>
                                <th>@lang('Tổng số tài sản')</th>
                                <th>@lang('Ngày hoàn trả')</th>
                                <th>@lang('Kỳ')</th>
                                <th>@lang('Ghi chú')</th>
                        ...
                        <tbody>
                            @foreach ($rows as $row)
                                <tr class="valign-middle">
                                    ...
                                    <td class="hide-print">
                                        <a class="btn btn-sm btn-info" data-toggle="tooltip" title="@lang('Chi tiết')"
                                            data-original-title="@lang('Chi tiết')"
                                            href="{{ route('warehouse_reimburse.show', $row->id) }}">

                        ...
                        <tbody>
                            ...
                            @foreach ($rows as $row)
                                ...
                                <tr class="valign-middle">
                                    <td>
                                        <strong style="font-size: 14px;">{{ $row->admin_name }}</strong>
                                    </td>
                                    <td>
                                        {{ $row->admin_email??'' }}
                                    </td>
                                    ...
                                    <td>
                                        {{ isset($row->syllabuss_json_params->price) ? number_format($row->syllabuss_json_params->price, 0, ',', '.'):'' }}
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        {{ App\Consts::ORDER_STATUS[$row->status] }}
                                    </td>
                                    <td class="d-flex-wap">
                                        <a class="btn btn-sm btn-warning" data-toggle="tooltip" title="@lang('view')" style="margin-right: 5px"

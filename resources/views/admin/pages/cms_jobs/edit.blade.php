                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input onchange="getValueTitle()" type="text"
                                                        ...
                                                        placeholder="@lang('Mã chương trình')" value="{{ $detail->job_code ?? '' }}">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select onchange="getparnerCode()"
                                                        ...
                                                        @foreach ($partner as $key => $val)
                                                            <option value="{{ $val->user_code }}"
                                                                {{ isset($detail->partner_code) && $detail->partner_code == $val->user_code ? 'selected' : '' }}>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input name="partner_code" type="text" onchange="getSyllabusCode()"
                                                        ...
                                                        placeholder="@lang('Mã đối tác')" value="{{ $detail->partner_code }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input onchange="getSyllabusCode()" type="number"
                                                        ...
                                                        placeholder="@lang('Số chương trình')" value="{{ $detail->maijor_quantity ?? '' }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select required name="maijor_code" class=" form-control select2">
                                                        ...
                                                        @foreach ($major as $key => $val)
                                                            <option value="{{ $val->code }}"
                                                                {{ isset($detail->maijor_code) && $detail->maijor_code == $val->code ? 'selected' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input onchange="getValueTitle()" type="number"
                                                        ...
                                                        placeholder="@lang('Số lượng')" value="{{ $detail->quantity ?? '' }}">
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select onchange="getprofession()" required name="industry_group"
                                                        ...
                                                        @foreach ($industry_group as $key => $val)
                                                                <option value="{{ $val->code }}"
                                                                    {{ isset($detail->industry_group) && $detail->industry_group == $val->code ? 'selected' : '' }}>
                                                                    @lang($val->name)</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input onchange="getValueTitle()" type="text"
                                                        ...
                                                        placeholder="@lang('Ngành nghề')" value="{{ $detail->profession ?? '' }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input onchange="getValueTitle()" type="text"
                                                        ...
                                                        placeholder="@lang('Bang')" value="{{ $detail->state ?? '' }}">
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="gender_job" class=" form-control select2">
                                                        @foreach ($gender_job as $key => $val)
                                                            <option value="{{ $key }}"
                                                                {{ isset($detail->gender_job) && $detail->gender_job == $key ? 'selected' : '' }}>
                                                                @lang($val)</option>
                                                        @endforeach
                                                    </select>
                                                </div>

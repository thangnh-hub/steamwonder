            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="form-group">
                            <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                                <label class="control-label"><strong>@lang('Tên Chu kỳ')</strong></label>
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="form-group">
                            <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                                <label class="control-label"><strong>@lang('Số tháng')</strong></label>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                                <p>{{ $detail->months ?? '1' }} Tháng</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="form-group">
                            <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                                <label class="control-label"><strong>@lang('Mặc định')</strong></label>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                                <div class="sw_featured d-flex-al-center">
                                    <label class="switch">
                                        <input class="teacher_main about-banner" type="checkbox" value="1" disabled
                                            {{ isset($detail->is_default) && $detail->is_default == '1' ? 'checked' : '' }}>

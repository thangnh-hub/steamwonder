...
@section('content')
    ...
    <section class="content">
        ...
        <form role="form" action="{{ route('leave.request.update', $detail->id) }}" method="POST"
                ...
                <div class="col-lg-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title text-uppercase">@lang('Chỉnh sửa đề xuất xin nghỉ')</h3>
                        </div>
                        @csrf
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select required name="is_type" class="form-control select2" style="width: 100%;">
                                            ...
                                            <option value="paid" {{ $detail->is_type == 'paid' ? 'selected' : '' }}>
                                                Có lương
                                            </option>
                                            <option value="unpaid" {{ $detail->is_type == 'unpaid' ? 'selected' : '' }}>
                                                Không lương
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input required type="number" step="0.5" min="0" class="form-control"
                                            name="total_days" value="{{ $detail->total_days ?? '' }}">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>@lang('Lý do xin nghỉ')<small class="text-red">*</small></label>
                                        <textarea name="reason" required class="form-control" rows="3">{{ $detail->reason ?? '' }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="row box_day">
                                            @if (isset($detail->json_params->teaching_day) && count($detail->json_params->teaching_day) > 0)
                                                @foreach ($detail->json_params->teaching_day as $item)
                                                    <div class="col-md-3 d-flex-wap items_day mb-10">
                                                        <input type="date" class="form-control mr-10"
                                                            name="json_params[teaching_day][]"
                                                            style="width: calc(100% - 50px)" value="{{ $item }}">

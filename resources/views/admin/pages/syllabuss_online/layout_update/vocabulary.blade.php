                    ...
                    <div class="nav-tabs-custom">
                        <div class="tab_offline">
                            <div class="tab-pane active">
                                @if (isset($lesson->json_params->vocabulary))
                                    @foreach ($lesson->json_params->vocabulary as $val)
                                        <div class="col-md-2 pl-0 mt-3 item_child">
                                            <div class="form-group" style="display: flex">
                                                <input class="form-control" data-toggle="tooltip" title=""
                                                    type="text" name="json_params[vocabulary][]"
                                                    placeholder="Nhập từ vựng..." value="{{ $val }}">

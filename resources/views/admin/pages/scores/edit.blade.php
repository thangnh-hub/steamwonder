        ...
        <form role="form" action="{{ route(Request::segment(2) . '.update', $detail->id) }}" method="POST">
            ...
            <div class="row">
                                ...
                                <ul class="nav nav-tabs">
                                    <li class="active">
                                        <a href="#tab_1" data-toggle="tab">
                                            <h5>Thông tin <span class="text-danger">*</span></h5>
                                        </a>
                                    </li>
                                </ul>
                                        ...
                                        <div class="d-flex-wap">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>@lang('Evaluation') <small class="text-red">*</small></label>
                                                    <textarea type="text" class="form-control" name="evaluation"
                                                        placeholder="@lang('Evaluation')"
                                                        required>{{ $detail->evaluation }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>@lang('Note')</label>
                                                    <textarea type="text" class="form-control" name="json_params[note]"
                                                        placeholder="@lang('Note')"
                                                        >{{ $detail->json_params->note }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">@lang('Student')</h3>
                        </div>
                        <div class="box-body">
                            <div class="form-group">
                                <select name="student_id" id="student_id" class="form-control select2" required>
                                    ...
                                    @foreach ($students as $item)
                                      <option value="{{ $item->id }}" {{ $detail->student_id == $item->id ? 'selected' : '' }}>
                                        {{ $item->name }}
                                      </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">@lang('Evaluation type')</h3>
                        </div>
                        <div class="box-body">
                            <div class="form-group">
                                <select name="is_type" class=" form-control select2">
                                    @foreach ($evaluation_type as $key => $val)
                                        <option value="{{ $key }}"
                                            {{ isset($detail->is_type) && $detail->is_type == $val ? 'selected' : '' }}>
                                            @lang($val)</option>
                                    @endforeach
                                </select>
                            </div>

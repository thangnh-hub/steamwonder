        ...
        <form role="form" action="{{ route(Request::segment(2) . '.update', $detail->id) }}" method="POST">
            ...
            <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="credit"
                                                        placeholder="@lang('Credit')"
                                                        value="{{ $detail->credit ?? old('credit') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">@lang('Subject')</h3>
                        </div>
                        <div class="box-body">
                            <div class="form-group">
                                <select name="subject_id" class=" form-control select2">
                                    @foreach ($parents as $val)
                                        ...
                                        <option value="{{ $val->id }}"
                                            {{ isset($detail->subject_id) && $detail->subject_id == $val->id ? 'selected' : '' }}>

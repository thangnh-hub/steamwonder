                                ...
                                <div class="d-flex-wap">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="description" value="{{ old('description', $detail->description) }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="iorder" value="{{ old('iorder', $detail->iorder) }}">
                                        </div>
                                    </div>

                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="keyword" placeholder="@lang('Tên vị trí, mã vị trí..')"
                                            ...
                                            @foreach ($rows as $sub_child)
                                                @if ($sub_child->parent_id == $sub->id)
                                                    <form action="{{ route(Request::segment(2) . '.destroy', $row->id) }}"
                                                        ...
                                                        <tr class="valign-middle">
                                                            <td>
                                                                - - - - - - {{ $i_row . '.' . $i_sub . '.' . $i_sub_child }}
                                                            </td>
                                                            <td>
                                                                - - - - - - {{ $sub_child->name ?? '' }}
                                                            </td>
                                                            <td>
                                                                {{ $sub_child->warehouse->name ?? '' }}
                                                            </td>

                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="prefix"
                                                        placeholder="@lang('Tiền tố')"
                                                        value="{{ $detail->prefix ?? old('prefix') }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="transcription"
                                                        placeholder="@lang('Phiên âm')"
                                                        value="{{ $detail->transcription ?? old('transcription') }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="meaning"
                                                        placeholder="@lang('Nghĩa tiếng việt')"
                                                        value="{{ $detail->meaning ?? old('meaning') }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>@lang('Giải thích bằng tiếng Đức')</label>
                                                    <textarea name="json_params[explanation][de]" class="form-control" rows="5">{{ $detail->json_params->explanation->de ?? old('json_params[explanation][de]') }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>@lang('Giải thích bằng tiếng Việt')</label>
                                                    <textarea name="json_params[explanation][vi]" class="form-control" rows="5">{{ $detail->json_params->explanation->vi ?? old('json_params[explanation][vi]') }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>@lang('Mẫu câu')</label>
                                                    <textarea name="json_params[sample]" id="sample" class="form-control" rows="5">{!! nl2br($detail->json_params->sample) ?? old('jjson_params[sample]') !!}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

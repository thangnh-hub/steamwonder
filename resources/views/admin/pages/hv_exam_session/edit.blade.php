                ...
                <div class="col-lg-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">@lang('Sửa phiên thi')</h3>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="json_params[exam_room]" class="form-control"
                                            value="{{ $detail->json_params->exam_room ?? old('json_params[exam_room]') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="day_exam"
                                            ...
                                            value="{{ $detail->day_exam ?? old('day_exam') }}" required>
                                    </div>
                                </div>
                                {{-- <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="time_exam"
                                            placeholder="@lang('Thời gian thi (phút)')"
                                            value="{{ $detail->time_exam ?? old('time_exam') }}" required>
                                    </div>
                                </div> --}}
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="time" class="form-control" name="start_time"
                                            placeholder="@lang('Thời gian bắt đầu')"
                                            value="{{ $detail->start_time ?? old('time_exam') }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="time" class="form-control" name="end_time"
                                            placeholder="@lang('Thời gian kết thúc')"
                                            value="{{ $detail->end_time ?? old('time_exam') }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select required name="id_invigilator" class="form-control select2" style="width:100%">
                                            ...
                                            @foreach ($list_admins as $val)
                                                <option value="{{ $val->id }}"
                                                    {{ $detail->id_invigilator == $val->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select required name="id_grader_exam" class="form-control select2" style="width:100%">
                                            ...
                                            @foreach ($list_admins as $val)
                                                <option value="{{ $val->id }}"
                                                    {{ $detail->id_grader_exam == $val->id ? 'selected' : '' }}>
                                                    @lang($val->name ?? '')</option>
                                            @endforeach
                                        </select>
                                    </div>
                                                    ...
                                                    @if ($list_student->count() > 0)
                                                        @foreach ($list_student as $item)
                                                            <tr class="valign-middle">
                                                                ...
                                                                <td>{{ $item->student->json_params->cccd ?? '' }}
                                                                </td>

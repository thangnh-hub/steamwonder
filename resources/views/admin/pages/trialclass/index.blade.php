                                ...
                                <tr class="valign-middle">
                                    ...
                                    <td style="width:150px">
                                        @if (!isset($row->syllabus->type) || isset($row->syllabus->type) && $row->syllabus->type != 'online')
                                            <p><a target="_blank"
                                                    href="{{ route('schedule_class.index', ['class_id' => $row->id]) }}">@lang('Lịch học')</a>
                                            </p>
                                            <p><a target="_blank"
                                                    href="{{ route('scores.index', ['class_id' => $row->id]) }}">@lang('Nhập điểm thi')</a>
                                            </p>
                                            <p><a target="_blank"
                                                    href="{{ route('evaluations.index', ['class_id' => $row->id]) }}">@lang('Nhận xét - Đánh giá')</a>
                                            </p>
                                            <p><a target="_blank"

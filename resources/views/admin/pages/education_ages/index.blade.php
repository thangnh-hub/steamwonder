                            ...
                            <div class="form-group">
                                ...
                                <select name="status" id="status" class="form-control select2" style="width: 100%;">
                                    ...
                                    @foreach ($status as $item)
                                        <option value="{{ $item }}"
                                            {{ isset($params['status']) && $params['status'] == $item ? 'selected' : '' }}>
                                            {{ __($item) }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <tbody>
                            @foreach ($rows as $row)
                                <tr class="valign-middle">
                                    ...
                                    <td>
                                        {{ $row->from_month ?? 0 }} tháng
                                    </td>
                                    <td>
                                        {{ $row->to_month ?? 0 }} tháng
                                    </td>
                                    <td>
                                        {{ $row->area->name ?? '' }}
                                    </td>
                                    ...
                                    <td>
                                        {{ \Carbon\Carbon::parse($row->created_at)->format('d/m/Y') }}</p>
                                    </td>

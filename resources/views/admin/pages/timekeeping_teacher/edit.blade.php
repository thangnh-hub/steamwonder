                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                                        ...
                                        <div class="d-flex-wap">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input required type="date" value="{{ $detail->date ?? "" }}" class="form-control" name="date">
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select required class="form-control select2"
                                                        ...
                                                        @foreach ($period as $key => $val)
                                                            <option {{ $detail->period== $val->id ? "selected" :"" }} value="{{ $val->id }}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select required class="form-control select2"
                                                        ...
                                                        @foreach ($type as $key => $val)
                                                            <option {{ $detail->type== $key ? "selected" :"" }} value="{{ $key }}">
                                                                {{ __($val )}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="note" rows="5">{{ $detail->note }}</textarea>
                                                </div>
                                            </div>
                            ...
                            <a class="btn btn-success " href="{{ route(Request::segment(2) . '.index') }}">
                                <i class="fa fa-bars"></i> Danh sách</a>
                        </div>
                        <!-- /.box-body -->

...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <form action="{{ route('dormitory.reportmuster') }}" method="GET" id="form_filter">
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>@lang('Area')<span class="text-red">*</span></label>
                                <select name="area_id" id="area_id" class="form-control area_id select2" required
                                    style="width: 100%;">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>@lang('Ngày') <span class="text-red">*</span></label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <a class="btn btn-default btn-sm" href="{{ route('dormitory.reportmuster') }}">
                                        @lang('Reset')
                                    </a>
                                </div>
                            </div>
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">@lang('Danh sách phòng theo khu vực')</h3>
            </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($rows as $row)
                                <tr class="valign-middle">
                                    ...
                                    <td>
                                        <a href="{{ route('dormitory.getmuster', ['id' => $row->id, 'time' => $params['time_muster']]) }}"
                                            target="_blank">
                                            <button class="btn btn-warning add_muster" data-id="{{ $row->id }}"
                                                style="margin-right: 5px">
                                                @lang('Xem chi tiết')</button>
                                        </a>

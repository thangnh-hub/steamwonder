                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input class="form-control"  name="date" type="date" value="{{ isset($params['date']) ? date('Y-m-d', strtotime($params['date'])) : '' }}">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="month" id="">
                                    ...
                                    @for ($i = 1; $i <= 12; $i++)
                                        <option {{ isset($params['month']) && $params['month'] == $i ? 'selected' : '' }} value="{{ $i }}">Tháng {{ $i }}</option>
                                    @endfor
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="year" id="">
                                    <option value="">Chọn</option>
                                    @for ($i = date('Y',strtotime('+5 years')); $i >= date('Y',strtotime('+5 years')) - 10; $i--)
                                        <option {{ isset($params['year']) && $params['year'] == $i ? 'selected' : '' }} value="{{ $i }}">{{ $i }}</option>
                                    @endfor
                                </select>
                            </div>
                        </div>

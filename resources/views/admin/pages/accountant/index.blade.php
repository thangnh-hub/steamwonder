                        ...
                        <tbody>
                            @foreach ($rows as $row)
                                <tr class="valign-middle">
                                    ...
                                    <td>
                                        <a href="{{ $row->json_params->link_cv ?? '#' }}" target="_blank" data-toggle="tooltip"
                                    ...
                                    <td>
                                        {{ $row->json_params->accountant_note ?? '' }}
                                    </td>
                                    <td>
                                        <strong
                                            style="font-size: 14px;">{{ isset($row->result_profile) && $row->result_profile != '' ? __($type_profile[$row->result_profile]) : 'Chưa cập nhật' }}</strong>
                                    </td>
                                    <td>
                                        @lang($row->status ?? '')
                                    </td>

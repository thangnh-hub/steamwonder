                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <a id="cv-avatar-link" href="{{ isset($detail->json_params->upload_image->avatar)?$detail->json_params->upload_image->avatar:asset('uploads/demo.jpg') }}" target="_blank">  
                                                        <div class="mx-3 pt-3 pb-3">
                                                            <img src="{{ isset($detail->json_params->upload_image->avatar)?$detail->json_params->upload_image->avatar:asset('uploads/demo.jpg') }}" class="img-thumbnail img-fluid mx-auto" alt="" id="cv-avatar">
                                                        </div>
                                                    </a>
                                                    <div class="mb-1">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group ">
                                                    ...
                                                    <div class="mt-3">
                                                        <label for="otherInput" class="btn btn-sm btn-info">
                                                            <i class="fa fa-upload"></i> Tải lên file khác(Tối đa 5 file)
                                                        </label>

                                                        <input type="file" id="otherInput" class="d-none" name="other_file[]" accept="video/mp4,video/x-msvideo,video/quicktime,image/*,application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,text/plain" multiple>
                                                        <div id="otherPreview" class="d-flex mt-2 flex-wrap">
...
<script>
    ...
    //Bằng tiếng đức
    $('#germanyInput').change(function(event) {
        var files = event.target.files;
        var preview = $("#germanyPreview");
        preview.html(""); // Xóa file cũ
    ...
    $('#otherInput').change(function(event) {
        var files = event.target.files;
        var preview = $("#otherPreview");
        preview.html(""); // Xóa file cũ
        ...
        for (let i = 0; i < files.length; i++) {
            ...
            if (file.type.startsWith("image/")) {
                ...
                let video_path = URL.createObjectURL(file);
                preview.append(`<a href="${video_path}" target="_blank"><video src="${video_path}" class="img-thumbnail m-1" style="width: 220px; height: auto ;" controls></video></a>`);
            }
            // Hiển thị icon PDF
            else  {
                let fileName = file.name; // Lấy tên file

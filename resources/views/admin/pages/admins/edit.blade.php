                    ...
                    <div class="d-flex-wap">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="@lang('Mã Code')" name="admin_code"
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="date" class="form-control" name="birthday" placeholder="@lang('Birthday')"
                      ...
                      @foreach ($area as $items)
                        <div class="col-md-4">
                          <ul class="checkbox_list">
                            ...
                            @endphp
                            <li>
                              <input name="json_params[area_id][]" type="checkbox" value="{{ $items->id }}"
                                id="json_access_menu_id_{{ $items->id }}" class="mr-15" {{ $checked }}>
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <select name="json_params[role_extend][]" id="role_extend" class="form-control select2"
                  ...
                  <option value="">@lang('Please select')</option>
                  @foreach ($roles as $item)
                    <option value="{{ $item->id }}" {{ in_array($item->id, $arr_role_extend) ? 'selected' : '' }}>
                      {{ $item->name }}
                    </option>
                  @endforeach
                </select>
              ...
              <div class="form-group">
                ...
                <select name="department_id" class="form-control select2">
                  ...
                  @foreach ($departments as $key => $val)
                    <option {{ $admin->department_id == $val->id ? 'selected' : '' }} value="{{ $val->id }}">
                      {{ $val->name ?? '' }}</option>
                  @endforeach
                </select>
              </div>

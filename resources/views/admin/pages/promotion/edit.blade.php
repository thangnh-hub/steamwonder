                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div
                                class="d-flex box_cycle {{ isset($detail->json_params->is_payment_cycle) && $detail->json_params->is_payment_cycle == 1 ? 'd-flex' : 'd-none' }}">
                                            ...
                                            @foreach ($service as $item_service)
                                                <li class="d-flex item_service">
                                                    ...
                                                    <input placeholder="Số lần áp dụng theo dịch vụ"
                                                        ...
                                                        type="number"
                                                        value="{{ $detail->json_params->payment_cycle->{$item_cycle->id}->services->{$item_service->id}->apply_count ?? '' }}">
                            ...
                            <div
                                class="box_default {{ isset($detail->json_params->is_payment_cycle) && $detail->json_params->is_payment_cycle == 1 ? 'd-none' : 'd-flex' }}">
                                <ul class="mt-15">
                                    @foreach ($service as $item_service)
                                        <li class="d-flex item_service">
                                            <input class="item_check mr-10 checkService" type="checkbox"

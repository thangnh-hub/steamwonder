                                        ...
                                        <div class="d-flex-wap">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>@lang('Mã danh mục')</label>
                                                    <input type="text" class="form-control" name="code"
                                                        placeholder="@lang('Mã danh mục')" value="{{ $detail->code ?? '' }}"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="name"
                                                        placeholder="@lang('Tên danh mục')" value="{{ $detail->name ?? '' }}"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="category_parent" class="form-control select2">
                                                        ...
                                                        @foreach ($categorys as $val)
                                                            <option value="{{ $val->id }}"
                                                                {{ isset($detail->category_parent) && $detail->category_parent == $val->id ? 'selected' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="code_auto"
                                                        ...
                                                        value="{{ old('code_auto') ?? $detail->code_auto }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>

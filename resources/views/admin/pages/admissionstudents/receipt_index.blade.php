...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <form action="{{ route('admission.receipt') }}" method="GET" id="form_filter">
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <a class="btn btn-default btn-sm" href="{{ route('admission.receipt') }}">
                                        @lang('Reset')
                                    </a>
                                ...
                                <tr class="valign-middle">
                                    ...
                                    <td class="">
                                        ...
                                        <button class="btn btn-sm btn-success btn_show_detail" data-toggle="tooltip"
                                            data-id="{{ $row->id }}"
                                            data-url="{{ route('receipt.view', $row->id) }}" title="@lang('Xem nhanh')"
                                            data-original-title="@lang('Xem nhanh')">
                                            <i class="fa fa-eye"></i>
                                        </button>
                                        @if ($admin_auth->id == $row->admin_created_id && $row->type_receipt == 'new_student')
                                            <a class="btn btn-sm btn-warning" data-toggle="tooltip"
                                                ...
                                                style="min-width: 34px" href="{{ route('receipt.show', $row->id) }}">
